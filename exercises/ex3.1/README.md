...
<table>
  ...
  <tr>
    ...
    <td> GET </td>
    <td> Non </td>
    <td> READ ALL : Lire toutes les ressources de la collection </td>
  </tr>
  ...
  <tr>
    ...
    <td> GET </td>
    <td> Non </td>
    <td> READ ALL : Lire une ressource de la collection </td>
  </tr>
  ...
  <tr>
    ...
    <td> POST </td>
    <td> Oui </td>
    <td> CREATE ONE : Créer une ressource de la collection basée sur un body au format {title: string; director: string;  duration: number;  budget?: number;  description?: string;  imageUrl?: string;  } </td>
  </tr>
  ...
  <tr>
    ...
    <td> DELETE </td>
    <td> Oui </td>
    <td> DELETE ONE : Effacer une ressource de la collection </td>
  </tr>
  ...
  <tr>
    ...
    <td> PATCH </td>
    <td> Oui </td>
    <td> UPDATE ONE : Modifier une ressource de la collection basée sur un body au format {title?: string; director?: string;  duration?: number;  budget?: number;  description?: string;  imageUrl?: string;  } en devant fournir au moins une propriété valide </td>
  </tr>
  ...
  <tr>
    ...
    <td> PUT </td>
    <td> Oui </td>
    <td> UPDATE ONE or CREATE ONE : Modifier une ressource de la collection si l'id existe, sinon créer une nouvelle ressource. Le format du body d'une requête {title: string; director: string;  duration: number;  budget?: number;  description?: string;  imageUrl?: string;  } </td>
  </tr>

</table>

<h2> API d'authentification </h2>
<table>
  ...
  <tr>
    ...
    <td> POST </td>
    <td> Non </td>
    <td> Permettre à un utilisateur de s'authentifier en sur base d'une ressource au format {username: string; password: string;}. Une fois l'utilisateur authentifié, celui-ci récupère son token et son username (format AuthenticatedUser) </td>
  </tr>
  ...
  <tr>
    ...
    <td> POST </td>
    <td> Non </td>
    <td> Créer un nouvel user et l'authentifier sur base d'une ressource au format {username: string; password: string;}. Une fois l'utilisateur créé et authentifié, celui-ci récupère son token et son username (format AuthenticatedUser) </td>
  </tr>

</table>

<h2> API de commentaires </h2>
<table>

  <tr>
    <td> comments?film=filmId	</td>
    <td> GET </td>
    <td> JWT </td>
    <td> READ ALL FILTERED : Lire toutes les ressources de la collection filtrée sur base d'un film </td>
  </tr>
  ...
  <tr>
    ...
    <td> POST </td>
    <td> JWT </td>
    <td> CREATE ONE : Créer une ressource basée sur un body au format {filmId: number; comment:string; } ; le username est sécurisé via le token. </td>
  </tr>

  <tr>
    <td> comments/films/:filmId	</td>
    <td> DELETE </td>
    <td> JWT </td>
    <td> DELETE ONE : Effacer le commentaire d'un utilisateur ou d'une utilisatrice sur un film sur base du filmId se trouvant dans l'URL et du username sécurisé dans le token. </td>
  </tr>
